    ...
    case msg of
        ...
        SetState message ->
            ...
            let 
                ...
                maybePage = Json.Decode.decodeString pageDecoder message

                maybeNumbers = Json.Decode.decodeString numbers message
                ...
                maybeBla = Json.Decode.decodeString blaDecoder message

                --races = z.races
                races = case maybeBla of
                            Ok val ->
                                val.races
